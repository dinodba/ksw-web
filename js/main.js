...
const maekchiki =      ['makchee ghi one',
                        'makchee ghi two',
                        'makchee ghi three',
                        'makchee ghi four',
                        'makchee ghi five',
                        ...
                        'makchee ghi eleven',
                        'makchee ghi twelve',
                        'makchee ghi thirteen',
                        'makchee ghi fourteen',
                        'makchee ghi fifteen'
                        ];

// Init the Maek Cha Ki array
const maekchaki =      ['makchaah ghi one',
                        'makchaah ghi two',
                        'makchaah ghi three',
                        'makchaah ghi four',
                        'makchaah ghi five',
                        ...
                        'makchaah ghi eleven',
                        'makchaah ghi twelve',
                        'makchaah ghi thirteen',
                        'makchaah ghi fourteen',
                        'makchaah ghi fifteen'
                        ];
...
const aobs =           ['app oobok soo one',
                        ...
                        'app oobok soo nine',
                        'app oobok soo ten',
                        'app oobok soo eleven',
                        'app oobok soo twelve',
                        'app oobok soo thirteen',
                        'app oobok soo fourteen',
                        'app oobok soo fifteen',
                        'app oobok soo sixteen',
                        'app oobok soo seventeen',
                        'app oobok soo eighteen',
                        'app oobok soo nineteen',
